...
create or replace function public.public_goals_assists(p_session_id uuid default null)
returns table(
  player_name text,
  season_id uuid,
  season_name text,
...
grant execute on function public.public_goals_assists(uuid) to anon, authenticated, service_role;
